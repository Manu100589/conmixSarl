          ...
          {commitments.map((item, idx) => {
            ...
            return (
              <Subtle3DAxis key={idx} maxTilt={6}>
                <div
                  className="interactive group relative p-8 rounded-2xl bg-[#0B0D0F] border border-white/10 hover:border-[#A71D2A] transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#A71D2A]/25 flex flex-col justify-between h-full"
                >
                  <div>
